...
x_explicit, bl_explicit, d1_explicit, d2_explicit, cf_explicit = run_explicit()

# Blasius
L = 8
Vinf = 1
nu = 1.5e-5
x_blasius = np.linspace(0.001, L, 400)  # Avoid x=0
...
plt.plot(x_explicit, bl_explicit, label="Explicit CFD", color="green", linestyle="--")
